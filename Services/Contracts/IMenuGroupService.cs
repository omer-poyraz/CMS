...
namespace Services.Contracts
{
    ...
    {
        Task<IEnumerable<MenuGroupDto>> GetAllMenuGroupsAsync(string lang, bool? trackChanges);
        Task<MenuGroupDto> GetMenuGroupByIdAsync(int id, string lang, bool? trackChanges);
